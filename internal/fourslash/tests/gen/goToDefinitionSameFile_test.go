...
var fooVar = /*localModuleReference*/localModule.foo;`
	...
	f.VerifyBaselineGoToDefs(t, "GetDefinitionAtPosition", "localVariableReference", "localFunctionReference", "localClassReference", "localInterfaceReference", "localModuleReference")
}
