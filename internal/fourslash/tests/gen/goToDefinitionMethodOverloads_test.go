...
methodOverload.[|/*instanceMethodReference2*/method|]("456");`
	...
	f.VerifyBaselineGoToDefs(t, "GoToDefinition", "staticMethodReference1", "staticMethodReference2", "instanceMethodReference1", "instanceMethodReference2", "staticMethodOverload1", "instanceMethodOverload1")
}
