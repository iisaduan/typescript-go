...
ambientClassVariable./*instanceMethodReference*/method();`
	...
	f.VerifyBaselineGoToDefs(t, "GetDefinitionAtPosition", "ambientVariableReference", "ambientFunctionReference", "constructorReference", "staticMethodReference", "instanceMethodReference")
}
